                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            {/* Ugarit Header & Version */}
                            <svg
                                className="w-full max-w-none translate-y-0 text-[#F53003] opacity-100 transition-all duration-750 dark:text-[#FF4433] starting:opacity-0 motion-safe:starting:translate-y-6"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                {/* Ugarit Isometric Cube Emblem */}
                                <g transform="translate(24, 20) scale(0.036)" fill="currentColor">
                                ...
                                {/* Ugarit Wordmark */}
                                <text x="106" y="66" fontFamily="'Instrument Sans', system-ui, -apple-system, sans-serif" fontWeight="800" fontSize="40" letterSpacing="4" fill="currentColor">
                                    UGARIT
                                </text>
                                {/* Version Badge */}
                                <g transform="translate(322, 34)">
                                    <rect width="90" height="32" rx="16" fill="currentColor" fillOpacity="0.1" stroke="currentColor" strokeWidth="1.5" />
                                    <text x="45" y="21" fontFamily="'Instrument Sans', monospace, sans-serif" fontWeight="700" fontSize="13" fill="currentColor" textAnchor="middle">
                                        v1.00.00
                                    </text>
                                </g>
                            </svg>

                            {/* Ugarit v1 Chromatic Artwork */}
                            <svg
                                className="relative -mt-[5rem] -ml-8 w-[438px] max-w-none [--stroke-color:#1B1B18] lg:ml-0 dark:[--stroke-color:#FF750F]"
                                viewBox="0 0 440 392"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                ...
                                <g className="text-[#1B1B18] opacity-100 mix-blend-darken transition-all delay-300 duration-750 dark:text-black dark:mix-blend-normal starting:opacity-0">
                                    <mask
                                        ...
                                        fill="black"
                                    >
                                        <rect fill="white" x="140" y="103" width="160" height="299" />
                                        <path d="M198.87 167.6H173.67V105.2H266.67V400.2H198.87V167.6Z" />
                                    </mask>
                                    <path
                                        d="M198.87 167.6H173.67V105.2H266.67V400.2H198.87V167.6Z"
                                        fill="currentColor"
                                    />
                                    <path
                                        d="M198.87 167.6H173.67V105.2H266.67V400.2H198.87V167.6Z"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 transition-all delay-400 duration-750 dark:text-[#4B0600] starting:opacity-0 motion-safe:starting:-translate-x-[26px]">
                                    <mask
                                        ...
                                        fill="black"
                                    >
                                        <rect fill="white" x="166" y="103" width="160" height="299" />
                                        <path d="M224.87 167.6H199.67V105.2H292.67V400.2H224.87V167.6Z" />
                                    </mask>
                                    <path
                                        d="M224.87 167.6H199.67V105.2H292.67V400.2H224.87V167.6Z"
                                        fill="currentColor"
                                    />
                                    <path
                                        d="M224.87 167.6H199.67V105.2H292.67V400.2H224.87V167.6Z"
                                ...
                                <g className="text-[#F8B803] opacity-100 mix-blend-color transition-all delay-400 duration-750 dark:text-[#391800] dark:mix-blend-hard-light starting:opacity-0 motion-safe:starting:-translate-x-[51px]">
                                    <mask
                                        ...
                                        fill="black"
                                    >
                                        <rect fill="white" x="191" y="103" width="160" height="299" />
                                        <path d="M249.87 167.6H224.67V105.2H317.67V400.2H249.87V167.6Z" />
                                    </mask>
                                    <path
                                        d="M249.87 167.6H224.67V105.2H317.67V400.2H249.87V167.6Z"
                                        fill="currentColor"
                                    />
                                    <path
                                        d="M249.87 167.6H224.67V105.2H317.67V400.2H249.87V167.6Z"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 mix-blend-multiply transition-all delay-400 duration-750 dark:text-[#733000] dark:mix-blend-normal starting:opacity-0 motion-safe:starting:-translate-x-[78px]">
                                    <mask
                                        ...
                                        fill="black"
                                    >
                                        <rect fill="white" x="218" y="103" width="160" height="299" />
                                        <path d="M276.87 167.6H251.67V105.2H344.67V400.2H276.87V167.6Z" />
                                    </mask>
                                    <path
                                        d="M276.87 167.6H251.67V105.2H344.67V400.2H276.87V167.6Z"
                                        fill="currentColor"
                                    />
                                    <path
                                        d="M276.87 167.6H251.67V105.2H344.67V400.2H276.87V167.6Z"
                                ...
                                <g className="text-[#F3BEC7] opacity-100 mix-blend-hard-light transition-all delay-400 duration-750 dark:text-[#4B0600] starting:opacity-0 motion-safe:starting:-translate-x-[102px]">
                                    <mask
                                        ...
                                        fill="black"
                                    >
                                        <rect fill="white" x="242" y="103" width="160" height="299" />
                                        <path d="M300.87 167.6H275.67V105.2H368.67V400.2H300.87V167.6Z" />
                                    </mask>
                                    <path
                                        d="M300.87 167.6H275.67V105.2H368.67V400.2H300.87V167.6Z"
                                        fill="currentColor"
                                    />
                                    <path
                                        d="M300.87 167.6H275.67V105.2H368.67V400.2H300.87V167.6Z"
                            ...
                            <div className="absolute bottom-6 left-0 right-0 text-center">
                                <span className="inline-flex items-center gap-2 rounded-full border border-[#19140020] bg-white/85 px-4 py-1.5 text-xs font-semibold tracking-wider text-[#1b1b18] backdrop-blur-sm shadow-sm dark:border-[#3E3E3A] dark:bg-[#161615]/85 dark:text-[#EDEDEC]">
                                    <span className="h-2 w-2 rounded-full bg-[#f53003] animate-pulse"></span>
                                    UGARIT ECOSYSTEM v1.00.00
                                </span>
                            </div>
